...
const displayError = (errorMessage) => {
    // Remove this if there is any success message
    success.style.display = "none"
...
const displaySuccess = (successMessage) => {
    // Remove this if there is any error message
    error.style.display = "none";
...
const handleSubmit = async (evt) => {
    ...
    if(!password.value.trim()) {
        return displayError("Enter new password!")
    }
    ...
    displaySuccess("Password reset successful!")
    password.value= "";
