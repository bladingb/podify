...
router.post('/create', mustAuth, isVerified, validate
(NewPlaylistValidationSchema), createPlaylist)

router.patch('/', mustAuth, isVerified, validate
(OldPlaylistValidationSchema), updatePlaylist)
